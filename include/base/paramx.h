...
C
C   NTGREN :
C     NOMBRE DE TABLEAUX D'ENTIERS ASSOCIES A UN NIVEAU DE MAILLAGE
C   NTGRRE :
C     NOMBRE DE TABLEAUX DE REELS ASSOCIES A UN NIVEAU DE MAILLAGE
C   NGRMMX :
C     NOMBRE MAX ABSOLU DE NIVEAUX DE MAILLAGES
C ATTENTION :
C NE PAS CHANGER NTGREN,NTGRRE
      INTEGER           NTGREN,NTGRRE,NGRMMX
      PARAMETER (NTGREN = 5)
      PARAMETER (NTGRRE = 3)
      PARAMETER (NGRMMX = 25)
C
