...
- Atmospheric Chemistry: fix run with use of SPACK-generated sources.
  ...
  function to the `cs_f_ssh_dimensions` C name. Files generated by SPACK may
  be used directly again while Files edited for v9.0.0 remain compatible.
...
- Fix checkpoint output frequency for HTSolver when defined by GUI and stop
  ...
  value to iteration based, leading to frequent outputs (every 10 iterations),
  in the final steps of a computation.
