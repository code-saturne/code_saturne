...
! RECALCUL EVENTUEL DE UET DEFINISSANT
! LA CONTRAINTE EN PAROI TAU = UET*UK
!   OU UK = CMU**0.25*K**0.5 POUR LE MODELE
!                               A DEUX ECHELLES DE VITESSE
!   ET UK = UET             POUR LE MODELE
!                               A UNE  ECHELLE  DE VITESSE


!   CE SOUS PROGRAMME EST APPELE DANS UNE BOUCLE
!    ATTENTION DE NE PAS TROP LE CHARGER
