...
!>
!> \brief Routine provided by SPACK. Return number of species / reactions
!------------------------------------------------------------------------------

! First version, for v9.0 only: using C binding to different name.
...
! Standard version, as generated by SPACK: with binding to C name
...
! The following binding restores compatibility with the legacy Fortran
! (i.e. without iso-c-bindings) version of ssh_dimensions
