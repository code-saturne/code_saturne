...
try:
    from code_saturne.gui.base.MainForm import Ui_MainForm
    from code_saturne.gui.base.NewCaseDialogForm import Ui_NewCaseDialogForm
except:
...
from code_saturne.gui.case.BatchRunningDialogView import BatchRunningDialogView
from code_saturne.gui.case.OpenTurnsDialogView import OpenTurnsDialogView
...
class MainView(object):
    ...
    def dataEditorOpen(self):
        ...
        from code_saturne.gui.base.QFileEditor import QFileEditor
    ...
    def testUserFilesCompilation(self):
        ...
        if len(usr_files) > 0:
            ...
            from code_saturne.gui.base.QFileEditor import QExpandingMessageBox
