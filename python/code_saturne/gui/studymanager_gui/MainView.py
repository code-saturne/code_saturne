...
from code_saturne.base.cs_exec_environment import \
    separate_args, update_command_single_value, assemble_args, enquote_arg

try:
    from code_saturne.gui.studymanager_gui.MainForm import Ui_MainForm
except:
    sys.path.insert(1, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "studymanager_gui"))
    from code_saturne.gui.studymanager_gui.MainForm import Ui_MainForm
...
from code_saturne.gui.studymanager_gui.BrowserView import BrowserView
from code_saturne.studymanager.cs_studymanager_xml_init import smgr_xml_init

from code_saturne.gui.case.WelcomeView import WelcomeView
