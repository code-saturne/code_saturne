...
from code_saturne.gui.case.BoundaryConditionsHydraulicHeadForm import \
...
class BoundaryConditionsHydraulicHeadView(QWidget, Ui_BoundaryConditionsHydraulicHeadForm):
    ...
    def slotHydraulicHeadValue(self, text):
        ...
        """
        if self.lineEditValueHydraulicHead.validator().state == QValidator.State.Acceptable:
    ...
    def slotHydraulicHeadFlux(self, text):
        ...
        """
        if self.lineEditExHydraulicHead.validator().state == QValidator.State.Acceptable:
            t = from_qvariant(text, float)
