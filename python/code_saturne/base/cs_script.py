...
Options:
  -h, --help  show this help message and exit"""
    ...
    def parametric(self, options = None):
        from code_saturne.base import cs_parametric_study
...
command"""
    ...
    def update(self, options = None):
        from code_saturne.base import cs_update
        return cs_update.main(options, self.package)

    def symbol2line(self, options = None):
        from code_saturne.base import cs_debug_symbol
