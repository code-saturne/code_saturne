...
from code_saturne.Base.QtPage import ComboModel, from_qvariant, to_text_string, BasicTableModel, DoubleValidator
from code_saturne.Pages.InterfacialForces import Ui_InterfacialForces
