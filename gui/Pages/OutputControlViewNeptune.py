...
from code_saturne.Pages.OutputControlView import OutputControlView as SaturneOutputControlView
from code_saturne.Pages.OutputControlModelNeptune import OutputControlModel
#-------------------------------------------------------------------------------
# Main class
#-------------------------------------------------------------------------------

class OutputControlView(SaturneOutputControlView):
    """
    """
    def __init__(self, parent, case, tree):
        ...
        Constructor
        """
        SaturneOutputControlView.__init__(self, parent, case, tree)
