...
if (ipdf1.eq.1 .or. ipdf2.eq.1 .or. ipdf3.eq.1) then
  ...
  do iel=1,ncel
    ...
    if (indpdf(iel) .eq. 1) then
      ...
      ! Calcul de l'enthalpie des vapeurs a Tfuel
  ...
  if (log_active .eqv. .true.) then
    ...
    write(nfecra,*) ' '
    write(nfecra,*) ' Min max of TSox ', toxmin, toxmax
    write(nfecra,*) ' Min max of TS4 ', ts4min, ts4max
    write(nfecra,*) '    number of points at Tmini < ts4 < 2400  ',inok
    write(nfecra,*) '    number of points at         ts4 < 0     ',imini
    write(nfecra,*) '    number of points at 0     < ts4 < 300   ',i000
    write(nfecra,*) '    number of points at 300   < ts4 < Tmini ',i300
    write(nfecra,*) '    number of points at 2400  < ts4 < 2500  ',i2500
    write(nfecra,*) '    number of points at 2500  < ts4 < 2600  ',i2600
    write(nfecra,*) '    number of points at 2600  < ts4 < 2700  ',i2700
    write(nfecra,*) '    number of points at 2700  < ts4 < 2800  ',i2800
    write(nfecra,*) '    number of points at 2800  < ts4 < 3000  ',i3000
    write(nfecra,*) '    number of points at 3000  < ts4 < 3500  ',i3500
    write(nfecra,*) '    number of points at 3500  < ts4 < 4000  ',i4000
    write(nfecra,*) '    number of points at 4000  < ts4 < 5000  ',i5000
    write(nfecra,*) '    number of points at 5000  < ts4         ',imaxi
    write(nfecra,*) ' Min max of TS4ad ',ts4admin,ts4admax
    write(nfecra,*) ' Min max concentration in fs4 ', sommin, sommax
    write(nfecra,*) ' Clip to min at ', nbclip1,' of ', nbpt,' points'
    write(nfecra,*) ' Clip to max at ', nbclip2,' of ', nbpt,' points'

    write(nfecra,*) ' '
    write(nfecra,*) ' Min max of Yo2ox at 0 ',yo2oxmin, yo2oxmax
    write(nfecra,*) ' Min max of Yo2 in fs4 before clipping ', yo2min, yo2max
    write(nfecra,*) ' Clip to min over Yo2 in fs4       ', nbclip30
    write(nfecra,*) ' Clip to max over Yo2 in fs4       ', nbclip31
    write(nfecra,*) ' Min max of Yo2 in fs4 after clipping ', yo2min1, yo2max1
