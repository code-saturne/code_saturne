                        ...
                        cs_real_t         *rovsdt)
{
  ...
  const cs_field_t *f_x_p = cs_field_by_name(f_name);
  const cs_real_t *cval_x_p = f_x_p->val_pre != NULL ? f->val_pre : f->val;
