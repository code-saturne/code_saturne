 ...
 *   force_p_r <--    wall-normal particle force
                      ...
                      cs_real_t *piiln)
{
  ...
  cs_real_t v_lim = *force_p_r * taup;
                          ...
                          cs_real_t *piiln)
{
  ...
  *vpart = vpart0 * etp + dd1 * vvue0 + tci * (ee1 - dd1) + v_lim * ee1;
  *dx    = aa1 * vpart0 + bb1 * vvue0 + cc1 * tci + (dtl - aa1) * v_lim;
