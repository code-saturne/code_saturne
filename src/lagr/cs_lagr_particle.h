...
template <typename T>
const T *
cs_lagr_particles_attr_n_get_ptr(const cs_lagr_particle_set_t *particle_set,
                                 cs_lnum_t                     particle_id,
                                 int                           time_id,
                                 cs_lagr_attribute_t           attr)
{
                              ...
                              cs_lagr_attribute_t             attr)
{
  ...
  return  (T *)particle + attr_map->displ[0][attr];
}
                                    ...
                                    cs_lagr_attribute_t             attr)
{
  ...
  return  (const T *)particle + attr_map->displ[0][attr];
}
                                ...
                                cs_lagr_attribute_t             attr)
{
  ...
  return  (T *)particle + attr_map->displ[time_id][attr];
}
                                      ...
                                      cs_lagr_attribute_t             attr)
{
  ...
  return  (const T *)particle + attr_map->displ[time_id][attr];
}
