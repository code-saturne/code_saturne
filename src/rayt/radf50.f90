...
! name             !type!mode ! role                                           !
!__________________!____!_____!________________________________________________!
! pco2             ! ra ! <-- ! CO2 volume fraction                            !
! ph2o             ! ra ! <-- ! H2O volume fraction                            !
! fv               ! ra ! <-- ! Soot volume fraction                           !
! teloc            ! ra ! <-- ! Gas temperature                                !
! kloc             ! ra ! --> ! Radiation coeffcient of the i different gases  !
! aloc             ! ra ! --> ! Weights of the i different gases in cells      !
! alocbo           ! ra ! --> ! Weights of the i different gases at boundaries !
!__________________!____!_____!________________________________________________!
