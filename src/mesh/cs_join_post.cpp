                 ...
                 const double  *field)
{
  ...
  const double  *var_ptr[9] = {nullptr, nullptr, nullptr,
                 ...
                 const int    *field)
{
  ...
  const int  *var_ptr[9] = {nullptr, nullptr, nullptr,
                            nullptr, nullptr, nullptr,
                            nullptr, nullptr, nullptr};
                          ...
                          const cs_lnum_t        selected_faces[])
{
  ...
  cs_join_mesh_t  *subset_mesh = nullptr;
                         ...
                         const cs_join_select_t  *join_select)
{
  ...
  fvm_nodal_t *adj_mesh = nullptr, *sel_mesh = nullptr;
  ...
  cs_post_activate_writer(_cs_join_post_param.writer_num, true);
                         ...
                         cs_join_param_t   join_param)
{
  ...
  int  writer_ids[] = {_cs_join_post_param.writer_num};
  char  *mesh_name = nullptr;
  cs_lnum_t  *post_i_faces = nullptr, *post_b_faces = nullptr;
  fvm_nodal_t  *post_i_mesh = nullptr;
