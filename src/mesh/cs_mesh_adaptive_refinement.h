#ifndef CS_MESH_ADAPTIVE_REFINEMENT_H
#define CS_MESH_ADAPTIVE_REFINEMENT_H
...
typedef struct {
  ...
  /*! Fields interpolation function for coarsening */
...
#endif /* CS_MESH_ADAPTIVE_REFINEMENT_H */
