...
cs_mesh_builder_t  *cs_glob_mesh_builder = nullptr;
...
cs_mesh_builder_create(void)
{
  ...
  mb->face_cells = nullptr;
  mb->face_vertices_idx = nullptr;
  mb->face_vertices = nullptr;
  mb->cell_gc_id = nullptr;
  mb->face_gc_id = nullptr;
  mb->vertex_coords = nullptr;

  /* Refinement features */

  mb->face_r_gen = nullptr;
  mb->vtx_r_gen = nullptr;

  /* Periodic features */

  mb->periodicity_num = nullptr;
  mb->n_per_face_couples = nullptr;
  mb->n_per_face_couples = nullptr;
  mb->n_g_per_face_couples = nullptr;
  mb->per_face_couples = nullptr;

  /* Optional partitioning info */

  mb->cell_rank = nullptr;
 ...
 * \param[in]       face_gnum     global face numbers, or nullptr
