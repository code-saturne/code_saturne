                 ...
                 cs_mesh_t   *mesh)
{
  ...
  this_join->selection =
    cs_join_select_create(selection_criteria,
                 ...
                 cs_join_stats_t        *stats)
{
  ...
  cs_gnum_t  *intersect_face_gnum = nullptr;
  cs_join_gset_t  *face_face_vis = nullptr, *edge_edge_vis = nullptr;
  cs_join_mesh_t  *work_mesh = nullptr;
...
{
  char  *mesh_name = nullptr;
  cs_real_t  *work_face_normal = nullptr;
  cs_join_gset_t  *edge_edge_vis = nullptr;
  cs_join_mesh_t  *loc_jmesh = nullptr, *work_jmesh = nullptr;
  cs_join_edges_t  *work_edges = nullptr;
  cs_join_param_t  param = this_join->param;
                 ...
                 cs_join_inter_edges_t  **p_inter_edges)
{
  ...
  cs_join_eset_t  *vtx_eset = nullptr;
  cs_join_inter_set_t  *inter_set = nullptr;
  cs_join_param_t  param = this_join->param;
  ...
  */
  ...
  if (join_type == CS_JOIN_TYPE_NULL) {
    ...
    if (n_ranks > 1 ) {
      ...
      cs_join_inter_edges_t  *sync_block = nullptr;
                        ...
                        cs_gnum_t         *p_o2n_vtx_gnum[])
{
  ...
  cs_gnum_t *new_local_gnum = nullptr;
                ...
                cs_mesh_t                *mesh)
{
  ...
  cs_gnum_t  *iwm_vtx_gnum = nullptr;
  ...
  assert(local_jmesh != nullptr);
  assert(work_jmesh != nullptr);
  assert(work_join_edges != nullptr);
...
{
  cs_join_param_t  param = this_join->param;
  cs_join_gset_t  *o2n_hist = *p_history, *n2o_hist = nullptr;
  ...
  n2o_hist = cs_join_gset_invert(o2n_hist);
    ...
    if (n_ranks > 1) {
      ...
      cs_join_gset_t  *n2o_sync_block = nullptr;
...
_split_faces(cs_join_t           *this_join,
             ...
             cs_mesh_builder_t   *mesh_builder)
{
  cs_join_gset_t  *history = nullptr;
  cs_join_param_t  param = this_join->param;
  cs_join_select_t  *selection = this_join->selection;
  cs_gnum_t  *rank_face_gnum_index = selection->compact_rank_index;
  ...
  if (cs_glob_mesh->verbosity > 0 && *join_type == CS_JOIN_TYPE_NULL) {
    ...
    *join_type = static_cast<cs_join_type_t>(_join_type);
...
cs_join_all(bool  preprocess)
{
  ...
  for (join_id = 0; join_id < cs_glob_n_joinings; join_id++) {
    ...
    if (cs_glob_join_array[join_id] == nullptr)
      continue;
    ...
    if (this_join->selection->n_g_faces > 0) {
      ...
      cs_real_t  *work_face_normal = nullptr;
      cs_join_gset_t  *edge_edge_visibility = nullptr;
      cs_join_mesh_t  *work_jmesh = nullptr, *local_jmesh = nullptr;
      cs_join_edges_t  *work_join_edges = nullptr;
      cs_join_eset_t  *vtx_eset = nullptr;
      cs_join_inter_edges_t  *inter_edges = nullptr;
      ...
      if (join_param.perio_type != FVM_PERIODICITY_NULL) {
        ...
        if (cs_glob_mesh_builder == nullptr)
   ...
   /* Optional synchronization (to be safe) */
    ...
    if (join_param.preprocessing) {
      ...
      cs_glob_join_array[join_id] = nullptr;
    }
                            ...
                            bool              b_select_flag[])
{
  ...
  fvm_group_class_set_t *_class_defs = nullptr;

  if (class_defs == nullptr) {
