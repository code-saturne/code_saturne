...
{
  /* Sanity checks */
  assert(prodq != nullptr && Qt != nullptr);
...
{
  const cs_basis_func_t  *bf = (const cs_basis_func_t *)pbf;
  assert(array != nullptr && dof != nullptr);
                       ...
                       cs_real_t            *eval)
{
  ...
  assert(coords != nullptr && eval != nullptr);
                       ...
                       const short int          id)
{
  ...
  cs_real_t   *phi_eval = nullptr, *weights = nullptr;
  cs_real_3_t *gpts = nullptr;
                     ...
                     short int      dim)
{
  ...
  pbf->projector             = nullptr;
  pbf->dump_projector        = nullptr;
  pbf->compute_projector     = nullptr;
  pbf->compute_factorization = nullptr;
  pbf->facto_max_size = 0;
  pbf->facto   = nullptr; /* array storing the matrix factorization */
  pbf->project = nullptr;

  pbf->n_gpts_tria = 0;
  pbf->quadrature_tria  = nullptr;
  pbf->n_gpts_tetra = 0;
  pbf->quadrature_tetra = nullptr;
...
cs_basis_func_grad_create(const cs_basis_func_t   *ref)
{
  ...
  gbf->setup          = nullptr; /* Copy from the reference. No need to set */
  gbf->projector      = nullptr;
  gbf->dump_projector = nullptr;
  gbf->compute_projector     = nullptr;
  gbf->compute_factorization = nullptr;
  gbf->facto_max_size = 0;
  gbf->facto            = nullptr; /* array storing the matrix factorization */
  gbf->project          = nullptr;
