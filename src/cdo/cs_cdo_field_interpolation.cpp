...
cs_equation_t  *_field_interpolation_scalar_c2v_eq = nullptr;
cs_equation_t  *_field_interpolation_scalar_c2f_eq = nullptr;
...
cs_cdo_field_interpolation_activate(cs_flag_t     mode)
{
  ...
  if (mode & CS_CDO_FIELD_INTERPOLATION_SCALAR_C2V) {
    ...
    cs_equation_param_set(eqp, CS_EQKEY_SOLVER_RTOL, "1e-4");
                                            ...
                                            cs_real_t          *vtx_values)
{
  ...
  if (_field_interpolation_scalar_c2v_eq == nullptr)
                                         ...
                                         cs_real_t          *face_values)
{
  ...
  if (_field_interpolation_scalar_c2f_eq == nullptr)
    bft_error(__FILE__, __LINE__, 0,
              " %s: Equation related to the interpolation of cell array to"
