 ...
 *         cell defined through a descriptor (\ref cs_xdef_t structure).
 *         The algorithm may use a \ref cs_cell_mesh_t structure.
 *
 * \param[in]  cm         pointer to a \ref cs_cell_mesh_t structure
 ...
 * \brief  Function pointer for evaluating a quantity defined through a
 *         descriptor (\ref cs_xdef_t structure) by a cellwise process (usage
 *         of a \ref cs_cell_mesh_t structure) which is hinged on integrals
 *
 * \param[in]  cm         pointer to a \ref cs_cell_mesh_t structure
 * \param[in]  time_eval  physical time at which one evaluates the term
