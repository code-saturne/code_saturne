                                ...
                                cs_cdofb_priv_t             *eqc)
{
  ...
  case CS_PARAM_ADVECTION_FORM_CONSERV:
    ...
    case CS_PARAM_ADVECTION_SCHEME_UPWIND_V8:
      eqc->advection_scheme = cs_cdofb_advection_upwcsv_v8;
      break;

    case CS_PARAM_ADVECTION_SCHEME_CENTERED_V8:
      eqc->advection_scheme = cs_cdofb_advection_cencsv_v8;
      break;

    case CS_PARAM_ADVECTION_SCHEME_L0:
      eqc->advection_scheme = cs_cdofb_advection_L0csv;
      break;
    ...
    case CS_PARAM_ADVECTION_SCHEME_SOLU_SYM: {
      eqc->advection_scheme = cs_cdofb_advection_solusymcsv;
  ...
  case CS_PARAM_ADVECTION_FORM_NONCONS:
    ...
    case CS_PARAM_ADVECTION_SCHEME_UPWIND_V8:
      eqc->advection_scheme = cs_cdofb_advection_upwnoc_v8;
      break;

    case CS_PARAM_ADVECTION_SCHEME_CENTERED_V8:
      eqc->advection_scheme = cs_cdofb_advection_cennoc_v8;
      break;

    case CS_PARAM_ADVECTION_SCHEME_L0:
      eqc->advection_scheme = cs_cdofb_advection_L0noc;
      break;
    ...
    case CS_PARAM_ADVECTION_SCHEME_SOLU_SYM: {
      eqc->advection_scheme = cs_cdofb_advection_solusymnoc;
      eqb->msh_flag |= CS_FLAG_COMP_HFQ;
    } break;
  ...
  if (cs_equation_param_has_diffusion(eqp)) {
    ...
    if (eqp->adv_scheme == CS_PARAM_ADVECTION_SCHEME_L0 &&
      ...
      bft_error(__FILE__,
                __LINE__,
                0,
                " %s: L0 advection scheme is not a valid option for"
