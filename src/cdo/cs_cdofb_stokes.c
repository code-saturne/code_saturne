 ...
 * \param[in]      eqc         pointer to a cs_cdofb_stokes_t structure
 ...
 * \param[in, out] eqc       pointer to a cs_cdofb_stokes_t structure
                             ...
                             cs_equation_builder_t       *eqb)
{
  ...
  cs_cdofb_stokes_t  *eqc = NULL;

  BFT_MALLOC(eqc, 1, cs_cdofb_stokes_t);
...
{
  cs_cdofb_stokes_t   *eqc  = (cs_cdofb_stokes_t *)data;
