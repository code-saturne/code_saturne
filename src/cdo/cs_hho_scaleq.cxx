...
void  *
cs_hho_scaleq_init_context(cs_equation_param_t    *eqp,
                           int                     var_id,
                           int                     bflux_id,
                                ...
                                cs_real_t                 **system_rhs)
{
  ...
  assert(*system_matrix == nullptr && *system_rhs == nullptr);
...
# pragma omp parallel if (quant->n_cells > CS_THR_MIN)
  {
    ...
    cs_equation_builder_init_properties(eqp, eqb, nullptr, cb);
...
#   pragma omp for CS_CDO_OMP_SCHEDULE
    for (cs_lnum_t c_id = 0; c_id < quant->n_cells; c_id++) {
      ...
      if (cb->cell_flag & CS_FLAG_BOUNDARY_CELL_BY_FACE) {
        ...
        if (cs_equation_param_has_diffusion(eqp)) {
          ...
          /* Weakly enforced Dirichlet BCs for cells attached to the boundary
             ...
             fm = nullptr, hodge = nullptr (not useful in the current cntext)
          */
          eqc->enforce_dirichlet(eqp, cm, nullptr, nullptr, cb, csys);
      ...
      cs_cdo_system_dblock_t *db
        = (cs_cdo_system_dblock_t *)block->block_pointer;
...
cs_real_t *
cs_hho_scaleq_get_face_values(void          *context,
                              bool           previous)
{
  cs_hho_scaleq_t  *eqc = (cs_hho_scaleq_t  *)context;
...
cs_real_t *
cs_hho_scaleq_get_cell_values(void          *context,
                              bool           previous)
{
  cs_hho_scaleq_t  *eqc = (cs_hho_scaleq_t  *)context;
...
void
cs_hho_scaleq_extra_post(const cs_equation_param_t  *eqp,
                         cs_equation_builder_t      *eqb,
                         void                       *context)
{
  cs_hho_scaleq_t  *eqc = (cs_hho_scaleq_t  *)context;
