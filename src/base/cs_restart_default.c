                        ...
                        cs_field_t    *f)
{
  ...
  /* Other fields may need specific renaming
    ...
    if (f == CS_F_(vel)) {
      ...
      strncpy(old_name, "R11", sizeof(old_name));
    else if (f == CS_F_(r22))
      strncpy(old_name, "R22", sizeof(old_name));
    else if (f == CS_F_(r33))
      strncpy(old_name, "R33", sizeof(old_name));
    else if (f == CS_F_(r12))
      strncpy(old_name, "R12", sizeof(old_name));
    else if (f == CS_F_(r13))
      strncpy(old_name, "R13", sizeof(old_name));
    else if (f == CS_F_(r23))
      strncpy(old_name, "R23", sizeof(old_name));
    else if (f == CS_F_(rij))
