...
struct _cs_part_to_block_t {
  ...
  int         *block_rank_id;   /* Block id for each part entity
                                   (nullptr if based on global_ent_num) */
...
_part_to_block_create(MPI_Comm comm)
{
  ...
  d->recv_count = nullptr;
  d->recv_displ = nullptr;

  d->block_rank_id = nullptr;
  d->send_block_id = nullptr;
  d->recv_block_id = nullptr;
  d->global_ent_num = nullptr;
  d->_global_ent_num = nullptr;
                     ...
                     MPI_Comm             comm)
{
  ...
  cs_lnum_t *send_block_id = nullptr;
                    ...
                    void                *block_values)
{
  ...
  unsigned char *_block_values = static_cast<unsigned char *>(block_values);
                      ...
                      void                *block_val)
{
  ...
  const unsigned char *_part_val = static_cast<const unsigned char *>(part_val);
  unsigned char       *_block_val = static_cast<unsigned char *>(block_val);
