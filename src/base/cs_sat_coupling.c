  ...
  for (int cpl_id = 0; cpl_id < cs_glob_sat_n_couplings; cpl_id++) {
    ...
    if (cpl->localis_cel != NULL) {
      ...
      if (n_g_cells_loc > 0 || n_g_cells_dist > 0) {
        /* First call */
        cs_real_t *_cw1_dis = (n_cells_dist > 0) ? cw1_dis : NULL;
        cs_real_t *_cw1_loc = (n_cells_loc > 0) ? cw1_loc : NULL;
        ...
        if (cpl->reverse == 1) {
          cs_real_t *_cw2_dis = (n_cells_dist > 0) ? cw2_dis : NULL;
          cs_real_t *_cw2_loc = (n_cells_loc > 0) ? cw2_loc : NULL;
          ple_locator_exchange_point_var(cells_locator,
                                         _cw2_dis,
                                         _cw2_loc,
                                         NULL,
