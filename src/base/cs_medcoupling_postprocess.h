...
cs_medcoupling_surface_intersection_by_id(const int id);
...
cs_medcoupling_slice_t *
cs_medcoupling_surface_intersection_by_name_try(const char *name);
...
cs_medcoupling_slice_t *
cs_medcoupling_surface_intersection_by_name(const char *name);
