...
static FILE* _cs_log[] = {nullptr, nullptr, nullptr, nullptr};
            ...
            int          align)
{
  ...
  assert(dest != nullptr && destsize > 0);
               ...
               va_list      arg_ptr)
{
  ...
  if (log != CS_LOG_DEFAULT) {
    ...
    if (_cs_log[log] == nullptr && log != CS_LOG_DEFAULT)
      _open_log(log);
 ...
 * \param[in]  calls         optional array of call counters, or nullptr
