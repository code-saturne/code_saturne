 ...
 *   weight          <-- optional weight related to each element, or nullptr
 ...
 *   f_input         <-- optional input to s_to_elt and compare, or nullptr
                     ...
                     MPI_Comm                      comm)
{
  ...
  const unsigned char *restrict _elts =
    static_cast<const unsigned char *>(elts);
  int  bucket_id = 1;
 ...
 *   n_elts          <-- local number of elements
 *   elts            <-- local list of elements to distribute
 *   weight          <-- optional weight for each element, or nullptr
 *   order           <-- ordering array
 *   s_to_elt        <-- pointer to coordinate to element conversion function
 *   compare         <-- pointer to comparison function
 *   f_input         <-- optional input to s_to_elt and compare, or nullptr
                  ...
                  MPI_Comm                       comm)
{
  ...
  unsigned char *_rank_index = static_cast<unsigned char *>(rank_index);
                 ...
                 const void                   *f_input)
{
  ...
  const unsigned char *_rank_index =
    static_cast<const unsigned char *>(rank_index);
 ...
 * \param[in]   weight           optional weight of each element, or nullptr
 ...
 * \param[in]   f_input          optional input to s_to_elt and compare, or nullptr
