                           ...
                           cs_lnum_t   *p_vtx_cells_lst[])
{
  ...
  cs_lnum_t  *vtx_buffer = nullptr, *vtx_count = nullptr, *vtx_tag = nullptr;
  cs_lnum_t  *vtx_cells_idx = nullptr, *vtx_cells_lst = nullptr;
                           ...
                           cs_lnum_t  *p_cell_cells_lst[])
{
  ...
  cs_lnum_t  *cell_buffer = nullptr, *cell_tag = nullptr, *cell_count = nullptr;
  cs_lnum_t  *cell_cells_idx = nullptr, *cell_cells_lst = nullptr;
...
_neighborhood_reduce_optimized(cs_mesh_t             *mesh,
                               ...
                               char                   cell_cells_tag[])
{
  cs_lnum_t  *cell_i_faces_idx = nullptr, *cell_i_faces_lst = nullptr;
  cs_lnum_t  *cell_b_faces_idx = nullptr, *cell_b_faces_lst = nullptr;
...
# pragma omp parallel if (n_cells > CS_THR_MIN)
  {
    ...
    cs_real_3_t *n_c_s = nullptr;
    cs_lnum_t   *i_c_selected = nullptr;
                           ...
                           cs_mesh_quantities_t  *mesh_quantities)
{
  ...
  cs_gnum_t n_n_sum[2] = { (cs_gnum_t)mesh->cell_cells_idx[n_cells], 0 };
