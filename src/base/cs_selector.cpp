                                ...
                                cs_lnum_t    b_face_num_list[])
{
  ...
  *n_b_faces = 0;
  ...
  if (cs_glob_mesh->select_b_faces == nullptr)
                                ...
                                cs_lnum_t    i_face_num_list[])
{
  ...
  *n_i_faces = 0;
  ...
  if (cs_glob_mesh->select_i_faces == nullptr)
    bft_error(__FILE__, __LINE__, 0,
              _("%sd: %s is not defined at this stage."),
                            ...
                            cs_lnum_t    b_face_list[])
{
  ...
  *n_b_faces = 0;
  ...
  if (cs_glob_mesh->select_b_faces != nullptr) {
    ...
    bool del_class_defs = (mesh->class_defs == nullptr) ? true : false;
                          ...
                          cs_lnum_t    cell_list[])
{
  ...
  *n_cells = 0;
  ...
  if (cs_glob_mesh->select_cells != nullptr) {
