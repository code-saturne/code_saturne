...
static _cs_real_11_t *_bc_coeffs_save = NULL;
 ...
 *
 * \param[in, out]  ms   pointer to mobile structures, or NULL
 */
/*----------------------------------------------------------------------------*/
 ...
 * \param[in]  ms      pointer to mobile structures, or NULL
...
{
  cs_mobile_structures_t *ms = _mobile_structures;
  int n_structs = (ms != NULL) ? ms->n_structs : 0;
...
cs_mobile_structures_restart_read(cs_restart_t  *r)
{
  ...
  n_str[0] = (ms != NULL) ? ms->n_structs : 0;
