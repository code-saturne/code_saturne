...
_write_main_checkpoint(void)
{
  ...
  /* Open restart file */
  cs_restart_t *r = cs_restart_create("main.csc", NULL, CS_RESTART_MODE_WRITE);
  ...
  cs_restart_write_variables(r, 0, NULL);
...
_read_main_checkpoint(void)
{
  ...
  /* Open file */
  cs_restart_t *r = cs_restart_create("main.csc", NULL, CS_RESTART_MODE_READ);
  ...
  cs_restart_read_variables(r, old_field_map, 0, NULL);
...
_write_auxiliary_checkpoint(void)
{
  ...
  cs_restart_write_linked_fields(r, "diffusivity_id", NULL);
  ...
  /* Mass fluxes */
  cs_restart_write_linked_fields(r, "inner_mass_flux_id", NULL);
  cs_restart_write_linked_fields(r, "boundary_mass_flux_id", NULL);
  ...
  int n_written_fields =
    cs_restart_write_linked_fields(r, "source_term_prev_id", NULL);
...
_read_auxiliary_checkpoint(cs_map_name_to_id_t *old_field_map)
{
  ...
  cs_restart_read_linked_fields(r, old_field_map, "diffusivity_id", NULL);
  ...
  cs_restart_read_linked_fields(r, old_field_map, "source_term_prev_id", NULL);
