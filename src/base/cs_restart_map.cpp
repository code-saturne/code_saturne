...
static  ple_locator_t  *_locator[4] = {nullptr, nullptr, nullptr, nullptr};

fvm_nodal_t  *_nodal_src = nullptr;
...
cs_restart_map_build(void)
{
...

  {
    ...
    cs_preprocessor_data_add_file(_mesh_input_path, 0, nullptr, nullptr);
