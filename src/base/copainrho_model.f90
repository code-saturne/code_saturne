...
!    rho_ref = 0.5*(rho_wall + cpro_rho(iel)) ! Two choices possible : rho at cell or average between cell and face values
!    rho_ref = cpro_rho(iel) ! Two choices possible : rho at cell or average between cell and face values
    rho_ref = rho_wall ! Two choices possible : rho at cell or average between cell and face values
