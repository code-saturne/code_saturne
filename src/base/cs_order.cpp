 ...
 *                 (if nullptr, a default 0 to n-1 numbering is considered)
 ...
 *
 * parameters:
 *   number   <-- array of entity numbers (if nullptr, a default 0 to n-1
 ...
 *                     exists (if nullptr, a default 0 to n-1 numbering is
 *                     considered)
 ...
 *                     If list = nullptr, a default 0 to n-1 numbering is considered)
 ...
 *                      if list exists (if nullptr, a default 0 to n-1 numbering is
 *                      considered)
 * \param[in]   stride  stride of number array (number of values to compare)
 * \param[out]  order   pointer to pre-allocated ordering table
 * \param[in]   nb_ent  number of entities considered
                          ...
                          size_t           nb_ent)
{
  ...
  /* Implicit numbering */
    ...
    cs_order_gnum_allocated(list, nullptr, order, nb_ent);
 ...
 *                      exists). If list = nullptr, a default 0 to n-1 numbering
 *                      is considered)
                     ...
                     cs_gnum_t        *single[])
{
  ...
  cs_lnum_t *order = cs_order_gnum(nullptr, number, n_ent);
