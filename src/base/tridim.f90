...
if (imobil.eq.1) then
  ...
  ! --- En turbomachine on connaÓt la valeur exacte de la vitesse de maillage
  ...
  ! On modifie la gÈomÈtrie en fonction de la gÈomÈtrie initiale
...
( ifinia , ifinra ,                                              &
  ...
  !       transformation de l'information re√ßue en condition limite.
