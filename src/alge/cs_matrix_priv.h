#ifndef CS_MATRIX_PRIV_H
#define CS_MATRIX_PRIV_H
...
typedef void(cs_matrix_set_coeffs_t)(cs_matrix_t       *matrix,
                                     bool               symmetric,
                                     bool               copy,
                                     cs_lnum_t          n_edges,
...
typedef void(cs_matrix_destroy_struct_t)(void **ms);

typedef void(cs_matrix_destroy_coeffs_t)(cs_matrix_t *matrix);

typedef void(cs_matrix_destroy_adaptor_t)(cs_matrix_t *matrix);

typedef void(cs_matrix_copy_diagonal_t)(const cs_matrix_t *matrix,
                                        cs_real_t         *da);

typedef const cs_real_t *(cs_matrix_get_diagonal_t)(const cs_matrix_t *matrix);
...
typedef void(cs_matrix_vector_product_t)(cs_matrix_t *matrix,
                                         bool         exclude_diag,
                                         bool         sync,
                                         cs_real_t   *x,
                                         cs_real_t   *y);
...
struct _cs_matrix_t {
  ...
  cs_matrix_vector_product_t
    *vector_multiply[CS_MATRIX_N_FILL_TYPES][CS_MATRIX_SPMV_N_TYPES];
  ...
  cs_matrix_vector_product_t
    *vector_multiply_h[CS_MATRIX_N_FILL_TYPES][CS_MATRIX_SPMV_N_TYPES];
  cs_matrix_vector_product_t
    *vector_multiply_d[CS_MATRIX_N_FILL_TYPES][CS_MATRIX_SPMV_N_TYPES];
