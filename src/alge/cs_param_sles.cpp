                                   ...
                                   int               fine_coarsening)
{
  ...
  if (fine_lvl_agg != CS_CDO_KEEP_DEFAULT)
    amgp->fine_level_threshold = fine_lvl_agg;

  if (fine_coarsening != CS_CDO_KEEP_DEFAULT)
    amgp->fine_level_aggreg_limit = fine_coarsening;
}
