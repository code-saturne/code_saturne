                          ...
                          const short int *restrict cell_i_faces_sgn)
{
  ...
  grad[c_id1][0][0] = _grad[0][0]; grad[c_id1][0][1] = _grad[0][1]; grad[c_id1][0][2] = _grad[0][2];
  grad[c_id1][1][0] = _grad[1][0]; grad[c_id1][1][1] = _grad[1][1]; grad[c_id1][1][2] = _grad[1][2];
  grad[c_id1][2][0] = _grad[2][0]; grad[c_id1][2][1] = _grad[2][1]; grad[c_id1][2][2] = _grad[2][2];
}
                              ...
                              const cs_lnum_t      *restrict cell_b_faces_idx)
{
  ...
  grad[c_id][0][0] = _grad[0][0]; grad[c_id][0][1] = _grad[0][1]; grad[c_id][0][2] = _grad[0][2];
  grad[c_id][1][0] = _grad[1][0]; grad[c_id][1][1] = _grad[1][1]; grad[c_id][1][2] = _grad[1][2];
  grad[c_id][2][0] = _grad[2][0]; grad[c_id][2][1] = _grad[2][1]; grad[c_id][2][2] = _grad[2][2];
}
