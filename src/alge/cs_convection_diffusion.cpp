   ...
   const cs_real_t             *i_massflux)
{
  ...
  cs_real_t *p_grdpa = reinterpret_cast<cs_real_t *>(grdpa);
...
(
  ...
  const cs_real_t             (*restrict grad)[3],
