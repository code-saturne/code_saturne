...
allows to determine $f_{s2}$ the stoichiometric point for the second reaction
...
reaction is known, a simple equation allows to determine $fs3$ the stoichiometric
...
The stoichiometric coefficient for char monomer beeing deducted from Carbon
...
the hottest particles are near the stoichiometric point ... where oxygen is
...
stoichiometric point for the "last" reaction ($H_{2}S$ conversion), the post
...
stoichiometric point corresponding to this last reaction is no more necessary to
