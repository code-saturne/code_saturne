...
\section*{Fonction}
%-------------------------------------------------------------------------------
Ce sous-programme, appel\'{e} entre autre par \fort{preduv}, \fort{turbke}, \fort{covofi},
...
$\tens{EM}_{n}$
n\'ecessaire lors de l'\'{e}tape de correction de la vitesse\footnote{cf. le sous-programme \fort{resolp}.}.
