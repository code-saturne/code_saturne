...
appel \`a \fort{cs\_solve\_equation\_scalar} plac\'e dans une boucle portant sur les \var{NSCAPP}
...
``utilisateurs'' (appel \`a \fort{cs\_solve\_equation\_scalar} dans une boucle portant sur les
