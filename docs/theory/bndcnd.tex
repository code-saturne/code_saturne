...
is referred to \fort{cs\_user\_physical\_properties} (see the \href{../../../doxygen/src/html/cs_user_physical_properties_8f90}{programmers reference of the dedicated subroutine})
