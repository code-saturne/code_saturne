...
dans \fort{cs\_boundary\_conditions}, $\alpha$ d\'esigne $\lambda+C_p\,\frac{\mu_t}{\sigma_t}$
...
On convertit ensuite ces donn\'ees dans \fort{cs\_boundary\_conditions} pour qu'elles
...
sont complets. Ils sont utilis\'es dans la suite de \fort{cs\_boundary\_conditions} et en particulier
...
de la temp\'erature sont compl\'et\'ees classiquement dans \fort{cs\_boundary\_conditions} selon
