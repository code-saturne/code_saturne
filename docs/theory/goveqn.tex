...
%
Note that a fluid for which \eqref{eq:goveqn:newtonian_fluid} holds are called a Newtonian fluid, it is generally the case
for water, air, but not the case of a paint because the stresses does not depends linearly of the strain rate.
...
%-------------------------------------------------------------------------
\subsection{Turbulent flows with a Reynolds Average Navier-Stokes approach (\emph{RANS}):}
