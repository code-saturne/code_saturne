...
\fort{cs\_physical\_properties\_update}         &                &                &
        ...
        & Calcul par l'utilisateur des propri\'et\'es physiques variables pour
                ...
                appel\'e par \fort{cs\_user\_physical\_properties}) \\
\end{tabular}
...
Le sous-programme \fort{cfbsc3} est similaire \`a \fort{cs\_balance}, mais il produit
...
Le sous-programme \fort{cfbsc2} est similaire \`a \fort{cs\_balance}, mais
...
Le sous-programme \fort{cfcdts} est similaire \`a \fort{cs\_equation\_iterative\_solve} mais fait appel
\`a \fort{cfbsc2} et non pas \`a \fort{cs\_balance}.
Il diff\`ere de \fort{cs\_equation\_iterative\_solve} par quelques autres d\'etails qui ne sont pas
...
%qu'il soit conforme \`a  \fort{cs\_equation\_iterative\_solve}.
