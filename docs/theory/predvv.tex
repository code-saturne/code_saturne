...
sous-programme utilisateur associ\'e \fort{cs\_user\_head\_losses.f90}). Cette prise en compte sera \`a am\'eliorer.\\
...
transpos\'{e} $ \dive (\mu_{\,tot} \,^t\ggrad \underline {u})$ sont calcul\'{e}s (s'ils sont pris en compte \emph{i.e.} \var{IVISSE} = 1. Il ne sont calcul\'{e}s qu'\`{a} la premi\`{e}re it\'{e}ration sur \fort{navstv}. Au cours de cette \'{e}tape, le tableau \var{TRAV} est utilis\'{e} comme tableau de travail lors de l'appel au sous-programme \fort{visecv}. Il retrouve sa valeur \`{a} la fin de cet appel, son contenu \'{e}tant temporairement stock\'{e} dans les vecteurs \var{W7} \`{a} \var{W9}.
\\
...
Pour finir, le r\'esidu de normalisation est d\'etermin\'e et stock\'e dans \var{RNORMP} par un appel \`a \fort{prodsc}  (qui r\'ealise le calcul de la somme sur les cellules du
...
Actuellement, dans le sous-programme utilisateur \fort{cs\_user\_head\_losses.f90}, une mise en
