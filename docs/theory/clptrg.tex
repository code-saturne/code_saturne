...
center
\end{quotation}of the boundary face, center of mass of its vertices) using the relation
$f_{b,int} = A_b+B_b\,f_{I'}$ ($f_{I'}$ is the value of the variable at point
$I'$, projection of the center of the boundary cell on the normal to the boundary face
and passing through its center: see figure~\ref{fig_flux_clptur}).
...
computation does require knowledge of the turbulent energy $k_I$ at the center of the
...
($\rho_I$ is the density at the center of cell $I$). The term requiring the boundary
