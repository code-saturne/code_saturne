...
Le but de ce sous-programme, appel\'e par \fort{cs\_equation\_iterative\_solve} et \fort{cs\_solve\_equation\_scalar}, est de construire la
...
trait\'es dans le sous-programme \fort{cs\_balance}. La partie
...
d\'efini dans \fort{cs\_solve\_navier\_stokes}) d'expression actuelle, pour tout cellule $\Omega_i$ de
centre $I$  :
\begin{equation}\notag
\begin{array}{lll}
