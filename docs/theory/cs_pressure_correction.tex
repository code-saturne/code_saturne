...
mesh\footnote{If $u_i$ is the value of a variable at the cell centers on a 1D Cartesian mesh, the Laplacian
...
formulation of the operator $\dive(\,\grad\,))$ defined in each cell\footnote{Recalling that $Neigh(i)$ is the set of cell centers of the neighbouring cells of ${\Omega_i}$ and
$\gamma_b(i)$ the set of centers of the boundary faces, if any, of ${\Omega_i}$.} $\Omega_i$ of center $I$ by\footnote{If $u_i$ is the value of a variable at the cell centers on a 1D Cartesian mesh, the Laplacian
