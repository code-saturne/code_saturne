...
In addition, the buoyancy term in the $k-\varepsilon $ turbulent closure has
...
With this law, the relationship between liquid water content $q_{l}$ and
$N_{d}$ is:
\begin{equation}
...
0 \textless $\zeta_{1}$ \textless $\zeta_{2}$:$_{\, }\Psi_{m} =a \log\frac{z_{2} }{z_{1}
...
\subsection{Estimation of ground temperature and humidity from an energetic budget}

\subsubsection{Soil temperature evolution}
The ground temperature T$_{s}$ (assimilated to the temperature at z$_{ot}$,
...
The evolution of the ground liquid water content is deduced from the same
...
which varies according to the nature of the surface (bare ground or ground
