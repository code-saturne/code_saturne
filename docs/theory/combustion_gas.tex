...
stoichiometric, the burnt gases contains only final products (none unburnt like
...
Where $f_{\mbox{\footnotesize s}}$ is the stoichiometric mixture fraction, $Y_s$
the concentrations in products of the complete reaction of a stoichiometric
...
the enthalpy of products $h_{\mbox{\footnotesize s}}$ (at the stoichiometric
...
stoichiometric point $(fs,0)$ is an auxiliary variable, the enthaply being
considered as a piecewise bilinear function. Fitting mean transported enthalpy
and integrated ones, allows to determine the enthalpy of stoichiometric
