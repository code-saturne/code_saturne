...
&
\displaystyle
+ C_{\varepsilon_1} \frac{\varepsilon^n}{k^n} \left[ \mathcal{P}^n + \mathcal{G}^n_{\varepsilon} \right]
...
center respectif $L$ (variable \var{II}) et $M$ (variable \var{JJ}), se trouvant de chaque c\^oté de la face
...
mesure algébrique du segment reliant les projections des centers des cellules
...
pour la cellule $\Omega_l$ représentée par $\var{IEL}$ de center $L$, on a~:
\begin{equation}\notag
\left\{\begin{array}{lll}
