...
\texttt{gettext()} possible, translatable strings should be
...
\item exactly 6 characters per routine name, with no underscores.
      ...
      characters.
      The \texttt{CS\_PROCF} macro must not be used for new code.
...
Code should work both using Python 2 or 3. Python 2 support will be
