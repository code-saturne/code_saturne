...
The available macros located in the \texttt{csmacros} package are displayed
in \tablename~\ref{tab:macros_soft} and \tablename~\ref{tab:macros_math}.

\begin{table}[!htbp]
\centering
\begin{tabular}{p{0.25 \textwidth} | p{0.25 \textwidth} }
\LaTeX\xspace code & preview \\
\hline
\verb1\CS1 & \CS \\
\verb1\syrthes1 & \syrthes
\end{tabular}
\caption{Macros of software names defined in \texttt{csmacros.sty}.\label{tab:macros_soft}}
\end{table}
