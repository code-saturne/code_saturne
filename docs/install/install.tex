...
In addition, its install structure is specific, and some header
files may be missing upon installation, so although \CS does its
best to find the appropriate files, separately specifying
\texttt{--with-coolprop-include} and \texttt{--with-coolprop-lib}
may be necessary. Using a post-install script to copy CoolProp's
headers from its source directory to the install directory
may be an alternative solution.

\fussy

As CoolProp seems to be an active project, things may become
...
\textbackslash \\
\textcolor{Violet}{--with-med}=/home/user/opt/med-3.1 \textbackslash \\
...
\textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.1/arch/athos
\textbackslash \\
...
\textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.1/arch/frontend
\textbackslash \\
...
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.1/arch/xc30 \textbackslash \\
