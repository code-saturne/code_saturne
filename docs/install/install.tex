...
\item BLAS (Basic Linear Algebra Subroutines) may be used for certain
      ...
      so no functionality is lost here. With optimized BLAS such as
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ /home/user/Code\_Saturne/2.2/saturne/configure \textbackslash \\
\textcolor{Violet}{--prefix}=/home/user/Code\_Saturne/2.2/arch/prod
\textbackslash \\
...
\textcolor{Violet}{--prefix}=/home/user/Code\_Saturne/2.2/arch/\textcolor{Magenta}{dbg}
\textbackslash \\
\textcolor{Violet}{--with-med}=/home/user/opt/med-3.0 \textbackslash \\
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ \textcolor{OliveGreen}{SRC\_PATH}=/home/projects/Code\_Saturne/2.2 \\
\$ \textcolor{OliveGreen}{INSTALL\_PATH}=/home/projects/Code\_Saturne/2.2 \\
...
\textcolor{Violet}{--with-scotch}=\textcolor{OliveGreen}{\$CS\_OPT}/scotch-5.1.12/arch/frontend \textbackslash \\
...
\textcolor{Violet}{--with-hdf5}=\textcolor{OliveGreen}{\$CS\_OPT}/hdf5-1.8.9/arch/bgp
\textbackslash \\
...
\textcolor{Violet}{--with-scotch}=\textcolor{OliveGreen}{\$CS\_OPT}/scotch-5.1.12/arch/bgp \textbackslash \\
\textcolor{Violet}{
