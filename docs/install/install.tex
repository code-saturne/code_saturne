...
GNU compilers 4.4 and above (up to 6.1 at this date), Intel compilers 11 and
above (up to 16 at this date), IBM XL Fortran 14 and C 12 compilers, and Clang
...
(so as to avoid polluting the source treee with cache files), the
...
\textcolor{Violet}{--prefix}=/home/user/Code\_Saturne/4.3/arch/prod
\textbackslash \\
\textcolor{Violet}{--with-med}=/home/user/opt/med-3.2 \textbackslash \\
...
\textcolor{Violet}{--prefix}=/home/user/Code\_Saturne/4.3/arch/\textcolor{Magenta}{dbg}
\textbackslash \\
\textcolor{Violet}{--with-med}=/home/user/opt/med-3.2 \textbackslash \\
...
\$ \textcolor{OliveGreen}{INSTALL\_PATH}=/home/projects/Code\_Saturne/4.3 \\
...
\textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.2/arch/athos
\textbackslash \\
...
\textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.2/arch/frontend
\textbackslash \\
...
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.1/arch/bgq \textbackslash \\
...
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.2/arch/xc30 \textbackslash \\
