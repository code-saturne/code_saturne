...
50, 51, 60 or 70 and {\tt ikecou}=0; if {\tt ikecou}=1, {\tt relaxv(ivar)}
is not used, whatever its value may be). Default values are 1. for turbulent
...
stored as fields containing the properties at the cells (see
