...
In \CS, the physical properties and some auxiliary numerical value arrays
are stored as fields. The most commonly used field ids are saved as
global variables.

The list of the most commonly used property field ids is given below (this does
...
\item If $C_p$ is variable, it can be specified in the interface or by
      ...
      \texttt{iel}, the value of $C_p$ is then defined in \texttt{usphyv} and
      stored in the field with idarray \texttt{icp}.
\end{list}
...
To assign a variable value to $C_p$, the user \textbf{must} specify it in the
      ...
      and define cell values for field \texttt{icp}
