...
The Interface is optional. Each setting or definition that can be specified
through the Interface can also be specified in the user subroutines. In case of
...
open a new one. The settings to be given or checked for a standard calculation are the
following:
