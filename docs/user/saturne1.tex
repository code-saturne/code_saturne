...
\hline
\texttt{flush\_logs}                        & $[$time\_step\_number$]$ \\
\hline
...
For the \texttt{flush\_logs} option, the time step is also optional. If not
specified, logs are updated at the beginning of the next time step.
