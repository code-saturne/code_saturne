...
\hline
Documentation:        & on-line documentation. Download link at \url{http://files.salome-platform.org/Salome/other/med-3.0.8.tar.gz}\\
\hline
\end{tabular}
...
progressively replaced by the \texttt{cs\_field} API and this process is now
still on-going only for the properties defined at cell centers. These
properties are therefore the last ones to be additionally accessible through a
deprecated multidimensional array:

\variab{propce}{propce(ncelet,nproce)}{ra}{Properties defined at the
cell centres. For instance: viscosity, ...}
...
variable index-numbers can be used to retrieve the corresponding field indices
...
\texttt{blencv(ik)} is the percentage of second-order convective scheme for the
turbulent energy when a corresponding turbulent model is used).
...
deducted. The total solved pressure is a field of type property.}.
...
\begin{list}{$\bullet$}{}
 ...
 solved variables. Instructions in the report which list \texttt
...
\item activate, for the variables which are specific to the activated specific
      ...
      the cell \texttt{iel} by \texttt{propce(iel,ipproc(iprop))}) are listed
      below:
      \begin{list}{$\rightarrow$}{}
...
%
\begin{figure}[ht]
 \centerline{\includegraphics[width=0.6\textwidth]{Atmospheric_user_s_guide_v91.png}}
...
%
\begin{figure}[ht]
\centerline{\includegraphics[width=5in,height=1.5in]{Atmospheric_user_s_guide_v92.pdf}}
...
%
\begin{figure}[ht]
\centerline{\includegraphics[width=4in,height=3in]{Atmospheric_user_s_guide_v93.pdf}}
...
%
\begin{figure}[htbp]
\centerline{\includegraphics[width=5in,height=1in]{Atmospheric_user_s_guide_v94.pdf}}
...
%
\begin{figure}[htbp]
\centerline{\includegraphics[width=\textwidth]{Atmospheric_user_s_guide_v95.pdf}}
\caption{Selection of automatic inlet/ outlet for boundary conditions }
\label{fig:inlet}
\end{figure}
%
\begin{figure}[htbp]
\centerline{\includegraphics[width=\textwidth]{Atmospheric_user_s_guide_v96.pdf}}
\caption{Selection of the boundary condition for the top of the domain }
\label{fig:top}
\end{figure}
%
\begin{figure}[htbp]
\centerline{\includegraphics[width=\textwidth]{Atmospheric_user_s_guide_v97.pdf}}
\caption{Selection of the boundary condition for building walls}
\label{fig:walls}
\end{figure}
%
\begin{figure}[htbp]
\centerline{\includegraphics[width=\textwidth]{Atmospheric_user_s_guide_v98.pdf}}
