...
...), from the boundary conditions defined in \texttt{cs\_user\_boundary\_conditions}, or even
...
stored in lagpar, whose default value is 100). A zone type is
...
classes is \texttt{nclagm\index{nclagm}} (parameter stored in lagpar,
