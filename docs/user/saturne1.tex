...
%==================================
\subsubsection{Activating the electric arc module}\label{sec:acti-lag}
%==================================

The activation of the electric arc module is performed either:
%
\begin{itemize}
...
by plane define is choosen then \texttt{idreca} define the current density component
and \texttt{crit\_reca} the plane used to scale.
\end{list}
