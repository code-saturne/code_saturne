...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=9cm,height=8cm]{\repgraphics/fig01.jpg}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=8cm,height=7cm]{\repgraphics/fig02.jpg}
\caption{Geometry of the downcomer}
\label{figante12}
\end{center}
\end{figure}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=2.5cm,height=6cm]{\repgraphics/fig03.jpg}
...
\begin{figure}[h]
\parbox{0.5\textwidth}{%
\includegraphics[width=4cm]{\repgraphics/cas1_t_1.jpg}}
\parbox{0.5\textwidth}{%
\includegraphics[width=4cm]{\repgraphics/cas1_t_10.jpg}}
\vspace*{0.5cm}
\parbox{0.5\textwidth}{%
\includegraphics[width=4cm]{\repgraphics/cas1_t_20.jpg}}
\parbox{0.5\textwidth}{%
\includegraphics[width=4cm]{\repgraphics/cas1_t_29.jpg}}
