...
\begin{figure}[!h]
\centerline{
\includegraphics*[width=14cm]{\repgraphics/cs_components.\extgraphics}}
...
information to the Kernel. Mesh joining and domain decomposition for parallel
...
corresponding user's guide \cite{ecsuser} (available on-line through the command
\texttt{cs\_info ecs\_user}).
...
compliant with this file format (mesh joining with hanging nodes, periodicity,
parallel computing, ...).
...
\begin{figure}[!h]
\centerline{
\includegraphics*[width=14cm]{\repgraphics/halo.\extgraphics}}
...
\begin{figure}[!h]
\centerline{
\includegraphics*[width=5.5cm]{\repgraphics/rota_perio_parall.jpg}}
...
workstation, use the command \texttt{cs\_info theory}.
