...
\item On the MFEE cluster, the launching of a parallel run
...
\item On the CCRT, the launching of a parallel run
...
\item Concerning periodicity, it is enough to complete the option
