...
whether a restart directory is present, and should ne be modified by
the user}
...
{relaxation coefficient of the turbulent
variables ($k$ and $\varepsilon$ or $\omega$) when {\tt ikecou} = 0. If
{\tt ikecou}=1, {\tt relaxk} is not used, whatever its value may be.\\
useful if and only if {\tt iturb} = 20, 21, 50 or 60 and {\tt ikecou}=0
...
{relaxation of the pressure increment during the
solution of the system ({\tt relaxp}=1: no relaxation)\\
...
\motcleb{nbrvap}{ca}{string of less than 80 characters}{name}{O}{L1}
...
\hspace*{1.3cm} {\tt nbrvap(itsray)}: radiative source term ($W/m^3$)\\
\hspace*{1.3cm} {\tt nbrvap(iqrayp)}: radiative flux density vector ($W/m^2$)\\
\hspace*{1.3cm} {\tt nbrvap(iabsp)}: absorption part in the source term
($W/m^3$)\\
\hspace*{1.3cm} {\tt nbrvap(iemip)}: emission part in the source term
($W/m^3$)\\
\hspace*{1.3cm} {\tt nbrvap(icakp)}: absorption coefficient of the
medium ($m^{-1}$)\\
the default values are: \\
\hspace*{1.3cm} {\tt nbrvap(itsray)} = Srad \\
\hspace*{1.3cm} {\tt nbrvap(iqrayp)} = Qrad \\
\hspace*{1.3cm} {\tt nbrvap(iabsp)} = Absorp \\
\hspace*{1.3cm} {\tt nbrvap(iemip)} = Emiss \\
\hspace*{1.3cm} {\tt nbrvap(icakp)} = CoefAb \\
useful if and only if the radiation module is activated}
...
\hspace*{1.3cm} {\tt irayvp(itsray)}: radiative source term ($W/m^3$)\\
\hspace*{1.3cm} {\tt irayvp(iqrayp)}: radiative flux density vector ($W/m^2$)\\
\hspace*{1.3cm} {\tt irayvp(iabsp)}: absorption part in the source term
($W/m^3$)\\
\hspace*{1.3cm} {\tt irayvp(iemip)}: emission part in the source term
($W/m^3$)\\
\hspace*{1.3cm} {\tt irayvp(icakp)}: absorption coefficient of the
medium ($m^{-1}$)\\
useful if and only if the radiation module is activated}
