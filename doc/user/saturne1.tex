...
of the \pcs will thus be the same as that of versions 1.0 et 1.1.
...
Graph partitioning (using the optional \emph{METIS}) is done using
...
Without partitioning (for example if the \emph{METIS} library
is not available, or the partitioner has not been run
