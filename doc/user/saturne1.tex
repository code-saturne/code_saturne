...
\begin{tabular}{|c|c|c|c|} \hline
 Lines  &Examples of values &        Variables             & Observations                                     \\ \hline
  ...
  7     &.35 .35 .35 .35 .35&  KABSE\index{KABSE}(NGAZE)   & Absorption coefficient                           \\
        &                   &                              & of  the current species                          \\ \hline
  8     &         4         &          NATO\index{NATO}    & Number of elemental species                      \\ \hline
  9     &.012  1  0  1  0  0& WMOLAT\index{WMOLAT}(NATO),  & Molar mass of the elemental                      \\
 10     &.001  4  0  0  2  0&                              & species (first column)                           \\
 11     &.016  0  2  2  1  0&ATGAZE\index{ATGAZE}(NGAZE,NATO)& Composition of the current species             \\
 12     &.014  0  0  0  0  2&                              & as a function of the elemental species           \\
        &                   &                              & (NGAZE following columns)                        \\ \hline
 13     &         3         &          NGAZG\index{NGAZG}  & Number of global species                         \\
        &                   &                              & Here, NGAZG = 3 (Fuel, Oxidiser and Products)    \\ \hline
 14     &  1. 0. 0. 0. 0.   &                              & Composition of the global species as a           \\
 15     &  0. 1. 0. 0. 3.76 &COMPOG\index{COMPOG}(NGAZE,NGAZG)& fonction of the current species of the line 6 \\
 16     &  0. 0. 1. 2. 7.52 &                              & In the order: Fuel (line 15),                    \\
        &                   &                              & Oxidiser (line 16) and Product (line 17)         \\ \hline
 17     &         1         &          NRGAZ\index{NRGAZ}  & Number of global reactions                       \\
        &                   &                              & Here NRGAZ = 1 (always equal to 1                \\
        &                   &                              & in this version)                                 \\ \hline
 18     &                   & IGFUEL\index{IGFUEL}(NRGAZ), & Numbers of the global species concerned by       \\
...
\begin{tabular}{|c|c|c|c|} \hline
 Lines  &            Examples of values     &        Variables            & Observations                                \\ \hline
  ...
  10    &    0.4      0.5       0.87        &CKABSG\index{CKABSG}(1),     & Absorption coefficient of fuel,             \\
        &                                   &                  CKABSG(2), & oxidiser                                    \\
        &                                   &                  CKABSG(3)  & and products                                \\ \hline
  11    &    1.       2.                    & XCO2\index{XCO2},   XH2O\index{XH2O}& Molar coefficents of $CO_2$         \\
...
\begin{tabular}{|c|c|c|c|} \hline
 Lines  &      Examples of values        &        Variables              & Observations                                         \\ \hline
  ...
  14    &               0.1              &         CKABS1\index{CKABS1}  & Constant absorption coefficient                      \\
        &                                &                               & for the gas mixture                                  \\ \hline
  15    &   CARACTERISTIQUES CHARBONS    &                               & Comment line                                         \\ \hline
  16    &               2                &         NCHARB\index{NCHARB}  & Number of coal types                                 \\ \hline
  17    &         1            1         &  NCLPCH\index{NCLPCH}(NCHARB) & Number of classes for each coal                      \\
        &                                &                               & (each column corresponding to                        \\
        &                                &                               & one coal type )                                      \\ \hline
  18    &    50.E-6        50.E-6        & DIAM20\index{DIAM20}(NCLACP)  & Initial diameter of each class (m)                   \\
  ...
  19    &    74.8          60.5          &         CCH\index{CCH}(NCHARB)& Composition in C (mass.-\%, dry) of each coal        \\ \hline
  20    &     5.1           4.14         &         HCH\index{HCH}(NCHARB)& Composition in H (mass.-\%, dry) of each coal        \\ \hline
  21    &    12.01          5.55         &         OCH\index{OCH}(NCHARB)& Composition in O (mass.-\%, dry) of each coal        \\ \hline
  22    & 0  31524000.    0  31524000.   &IPCI\index{IPCI}(NCHARB),      & Value of the PCI ($Jkg^{-1}$) for each coal,         \\
        &                                & PCICH\index{PCICH}(NCHARB)    & the first integer indicating if this value refers    \\
        &                                &                               & to pure (0) or dry coal (1)                          \\ \hline
  23    &   1800.      1800.             &        CP2CH\index{CP2CH}(NCHARB)& Heat-storage capacity at constant pressure        \\
        &                                &                               & ($Jkg^{-1}K^{-1}$) for each coal                     \\ \hline
  24    &   1200.      1200.             &RHO0CH\index{RHO0CH}(NCHARB)   & Initial density ($kgm^{-3}$) of each                 \\ \hline
  25    &          Coke                  &                               & Comment line                                         \\ \hline
  26    &      0.         0.             &        CCK\index{CCK}(NCHARB) & Composition in C (mass.-\%, dry) of the coke         \\
        &                                &                               & for each coal                                        \\ \hline
  27    &      0.         0.             &        HCK\index{HCK}(NCHARB) & Composition in H (mass.-\%, dry) of the coke         \\
        &                                &                               & for each coal                                        \\ \hline
  28    &      0.         0.             &        OCK\index{OCK}(NCHARB) & Composition in O (mass.\%, dry) of the coke          \\
        &                                &                               & for each coal                                        \\ \hline
  29    &      0.         0.             &     PCICK\index{PCICK}(NCHARB)& PCI of the dry coke ($Jkg^{-1}$) for each coal       \\ \hline
  30    &          Cendres               &                               & Comment line                                         \\ \hline
  31    &      6.3        6.3            &   XASHCH\index{XASHCH}(NCHARB)& Ash mass fraction (mass.-\%, dry) in each coal       \\ \hline
  32    &      0.         0.             & H0ASHC\index{H0ASHC}(NCHARB)  & Ash formation enthalpy ($Jkg^{-1}$)                  \\
        &                                &                               & for each coal                                        \\ \hline
  33    &      0.         0.             &CPASHC\index{CPASHC}(NCHARB)   & CP of the ashes ($Jkg^{-1}K^{-1}$) for each coal     \\ \hline
  34    &  D\'evolatilisation (Kobayashi)  &                             & Comment line                                         \\ \hline
  35    &  1  0.37      0  0.37          & IY1CH\index{IY1CH}(NCHARB),   & For each coal, pairs (IY1CH, Y1CH).                  \\
  ...
  36    &  1  0.74      1  0.74          & IY2CH\index{IY2CH}(NCHARB),   & For each coal, pairs (IY2CH, Y2CH).                  \\
  ...
  37    &  370000.      410000.          &       A1CH\index{A1CH}(NCHARB)& Devolatilisation pre-exponential factor A1 ($s^{-1}$)\\
        &                                &                               & for each coal (light volatile matters)               \\ \hline
  38    &  1.3E13       1.52E13          &       A2CH\index{A2CH}(NCHARB)& Devolatilisation pre-exponential factor A2 ($s^{-1}$)\\
        &                                &                               & for each coal (heavy volatile matters)               \\ \hline
  39    &   74000.       80000.          &       E1CH\index{E1CH}(NCHARB)& Devolatilisation activation energy E1 ($Jmol^{-1}$)  \\
        &                                &                               & for each coal (light volatile matters)               \\ \hline
  40    &  250000.      310000.          &       E2CH\index{E2CH}(NCHARB)& Energie d'activation E2 ($Jmol^{-1}$) de d\'evolatilisation\\
        &                                &                               & for each coal (heavy volatile matters)               \\ \hline
  41    &  Combustion h\'et\'erog\`ene   &                               & Ligne de commentaire                                 \\ \hline
  42    &      17.88        17.88        &AHETCH\index{AHETCH}(NCHARB)   & Char burnout pre-exponential constant                \\
        &                                &                               & ($kgm^{-2}s^{-1}atm^{-1}$) for each coal             \\ \hline
  43    &      16.55        16.55        &EHETCH\index{EHETCH}(NCHARB)   & Char burnout activation energy ($kcalmol{-1}$)       \\
        &                                &                               & for each coal                                        \\ \hline
  44    &       1            1           &IOCHET\index{IOCHET}(NCHARB)   & Char burnout reaction order for each coal            \\
