...
\item Install a local Python interpreter, and add Qt4 bindings to this
      ...
      script by passing \texttt{--with-python-exec=<python\_bin\_prefix}.
...
\$ tar xvzf ecs-2.0.3.tar.gz\\
\$ tar xvzf fvm-0.15.4.tar.gz\\
\$ tar xvzf mei-1.0.4.tar.gz\\
\$ tar xvzf ncs-2.0.6.tar.gz
}\end{minipage}}
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ /home/user/Code\_Saturne/2.0/fvm-0.15.4/configure \textbackslash \\
...
\$ \textcolor{Magenta}{module load} intel\_compilers/11.1.072 \\
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ mkdir -p ecs-2.0.3\_build/ivanoe \&\& cd ecs-2.0.3\_build/ivanoe\\
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/ecs-2.0.3/configure \textbackslash \\
...
\textcolor{Violet}{--with-scotch}=\textcolor{OliveGreen}{\$CS\_OPT}/scotch-6.0/arch/ivanoe \textbackslash \\
\textcolor{Violet}{--with-metis}=\textcolor{OliveGreen}{\$CS\_OPT}/metis-5.0/arch/ivanoe \textbackslash \\
\textcolor{red}{CC}=icc \\
\$ make -j 4 \&\& make install \&\& make clean\\
\$ cd ..
}\end{minipage}}
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ mkdir -p fvm-0.15.4\_build/ivanoe \&\& cd fvm-0.15.4\_build/ivanoe\\
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/fvm-0.15.4/configure \textbackslash \\
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ mkdir -p mei-1.0.4\_build/ivanoe \&\& cd mei-1.0.4\_build/ivanoe\\
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/mei-1.0.4/configure \textbackslash \\
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/ivanoe
\textbackslash \\
\textcolor{Magenta}{--with-bft}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/ivanoe
\textbackslash \\
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$  mkdir -p ncs-2.0.6\_build/ivanoe \&\& cd ncs-2.0.6\_build/ivanoe\\
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/ncs-2.0.6/configure \textbackslash \\
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/ivanoe\_ompi
\textbackslash \\
...
\textcolor{Violet}{--with-batch}=SLURM \textbackslash \\
...
\textcolor{Violet}{--with-scotch}=\textcolor{OliveGreen}{\$CS\_OPT}/scotch-6.0/arch/frontend \textbackslash \\
\textcolor{Violet}{--with-metis}=\textcolor{OliveGreen}{\$CS\_OPT}/metis-5.0/arch/frontend \textbackslash \\
\textcolor{red}{CC\_ADD}="-m64" \textbackslash \\
\textcolor{red}{LD\_ADD}="-m64"
}\end{minipage}}
...
\textcolor{Magenta}{--host}=bluegenep \textbackslash \\
\textcolor{Violet}{--with-python-exec}=\textcolor{OliveGreen}{\$CS\_OPT}/python-2.7.1/arch/frontend/bin \textbackslash \\
\textcolor{red}{CC}=mpixlc\_r \textcolor{red}{FC}=bgxlf90\_r \textbackslash \\
\textcolor{red}{LIBS}=/bgsys/drivers/ppcfloor/ppc/gnu-linux/powerpc-bgp-linux/lib/libstdc++.a
}\end{minipage}}
...
not with the single-threaded versions, as they have a dependency on threading
functions of the XL Fortran runtime.
The \texttt{LIBS} value used here is the same as that for the FVM library, and is useful only when
FVM is built with MED output format support.
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/bft-1.0.5/configure \textbackslash \\
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Violet}{--disable-shared} \textbackslash \\
\textcolor{Magenta}{--build}=ppc64 \textbackslash \\
\textcolor{Magenta}{--host}=bluegenep \textbackslash \\
\textcolor{red}{CC}=bgxlc
}\end{minipage}}

For the front-end nodes, no special options are necessary either:

\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/bft-1.0.5/configure \textbackslash \\
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq\_fen \textbackslash
}\end{minipage}}
...
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/ecs-2.0.3/configure \textbackslash \\
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq\_fen \textbackslash \\
\textcolor{Magenta}{--with-bft}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--with-hdf5}=\textcolor{OliveGreen}{\$CS\_OPT}/hdf5-1.8.9/arch/bgq\_fen
\textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.0/arch/bgq\_fen
\textbackslash \\
\textcolor{Violet}{--with-cgns}=\textcolor{OliveGreen}{\$CS\_OPT}/cgns-3.1/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--with-ccm}=\textcolor{OliveGreen}{\$CS\_OPT}/libccmio-2.6.1/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--with-scotch}=\textcolor{OliveGreen}{\$CS\_OPT}/scotch-6.0/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--without-metis}
}\end{minipage}}
...
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/fvm-0.15.4/configure \textbackslash \\
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Magenta}{--with-bft}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{red}{CC}=mpixlc
}\end{minipage}}
...
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Magenta}{--with-bft}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Violet}{--with-hdf5}=\textcolor{OliveGreen}{\$CS\_OPT}/hdf5-1.8/arch/bgq
\textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.0/arch/bgq
\textbackslash \\
\textcolor{Violet}{--with-med-dep-dirs}=/opt/ibmcmp/lib/bg/lib \textbackslash \\
\textcolor{Violet}{--with-med-dep-libs}=ibmc++ \textbackslash \\
\textcolor{Violet}{--with-cgns}=\textcolor{OliveGreen}{\$CS\_OPT}/cgns-3.1/arch/bgq \textbackslash \\
\textcolor{Violet}{--enable-long-gnum} \textbackslash \\
\textcolor{Magenta}{--disable-shared} \textbackslash \\
\textcolor{red}{CC}=/bgsys/drivers/ppcfloor/comm/xl/bin/mpixlc \textbackslash \\
\textcolor{red}{LD\_ADD}=-R/opt/ibmcmp/lib/bg/lib
}\end{minipage}}
...
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq\_fen \textbackslash \\
\textcolor{Magenta}{--with-bft}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--with-hdf5}=\textcolor{OliveGreen}{\$CS\_OPT}/hdf5-1.8.9/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/med-3.0/arch/bgq\_fen
\textbackslash \\
\textcolor{Violet}{--with-med}=\textcolor{OliveGreen}{\$CS\_OPT}/cgns-3.1/arch/bgq\_fen
\textbackslash \\
}\end{minipage}}
...
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Magenta}{--with-bft}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Violet}{--with-swig-exec}=\textcolor{OliveGreen}{\$CS\_OPT}/swig-1.3.39/arch/bgq\_fen/bin \textbackslash
}\end{minipage}}
...
\fbox{\begin{minipage}{\textwidth}\texttt{\\
\$ \textcolor{OliveGreen}{\$SRC\_PATH}/ncs-2.0.6/configure \textbackslash \\
\textcolor{Violet}{--prefix}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq\_ompi
\textbackslash \\
\textcolor{Magenta}{--with-bft}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Magenta}{--with-fvm}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Magenta}{--with-mei}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq \textbackslash \\
\textcolor{Magenta}{--with-prepro}=\textcolor{OliveGreen}{\$INSTALL\_PATH}/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--with-blas}=/opt/ibmmath/essl/5.1 \textbackslash \\
\textcolor{Violet}{--with-blas-type}=ESSL \textbackslash \\
\textcolor{Violet}{--with-libxml2}=\textcolor{OliveGreen}{\$CS\_OPT}/libxml2-2.8/arch/bgq\_fen \textbackslash \\
\textcolor{Violet}{--with-batch}=SLURM\_BGQ \textbackslash \\
\textcolor{Violet}{--disable-sockets} \textbackslash \\
\textcolor{Violet}{--disable-nls} \textbackslash \\
\textcolor{red}{CC}=/bgsys/drivers/ppcfloor/comm/xl/bin/mpixlc \textcolor{red}{FC}=bgxlf95\_r
}\end{minipage}}
