...
Linking with MED and HDF5 also almost doubles
the size of the Kernel executable, bringing it above 50 Mb,
so building FVM with support for MED may be worthwhile
