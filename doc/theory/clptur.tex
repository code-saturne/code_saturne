...
{\bf Remark~:} Note that the user subroutine \fort{usruet} permits to modify 
...
are available in the arguments of \fort{usruet}).
...
directly in  \fort{clptur}. The user can then modify the velocity scales 
(to take into account a rough wall, or variants of the logarithmic law
for instance) in the user subroutine  \fort{usruet}.
