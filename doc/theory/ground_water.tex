...
%===============================================
Finally, the dispersion tensor $D_{ij}$ is the cumulation of the kinematic dispersion tensor $D_k$ and the molecular diffusion scalar.
In a frame independent of the flow, it can be written:
...
However, these properties are rarely verified. Indeed, sorption and desorption
